...
`FastMCP` object `python -m world.tools.server` runs, through a genuine MCP
...
from world.tools.client import result_text  # noqa: E402
from world.tools.server import build_server  # noqa: E402
from world.tools.weather import FakeWeather  # noqa: E402
