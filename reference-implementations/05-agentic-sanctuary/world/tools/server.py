...
Run standalone (`python -m world.tools.server`) it speaks MCP over stdio; the
...
def build_server(*, weather: WeatherProvider | None = None,
    ...
    if selfies:
        ...
        # validates the ask against the vendored template library and answers
        ...
        def take_selfie(scene: str = "", mood: str = "") -> dict:
