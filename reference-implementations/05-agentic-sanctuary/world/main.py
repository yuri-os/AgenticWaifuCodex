"""Build #5 — the agentic sanctuary (SPEC §1, §15).
...
def create_app(cfg: Config | None = None, *, brain=None, chat_model=None,
    ...
    app = FastAPI(title="agentic-sanctuary", docs_url=None, redoc_url=None,
                  lifespan=lifespan)
    app.state.rt = rt
    ...
    from .routes import events, health, live2d, mind, voice_ws
