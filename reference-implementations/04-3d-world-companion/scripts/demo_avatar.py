...
Boots the server with fake voice backends, no tools and no idle machine, then
...
os.environ.setdefault("IDLE_ENABLED", "false")

from world.config import Config  # noqa: E402
from world.main import build_server, create_app  # noqa: E402
