...
- **The IP collision is the big one.** The character is reserved as **all-rights-reserved, trademarked brand IP — the whole moat is that nobody can *be* her without you** (D-015; ch. 41). An NFT that conveys image or derivative rights to Yuri would sell *off* the moat; an NFT that conveys *no* rights is just a numbered receipt for a JPEG and most buyers know it. You must decide, before any drop, exactly what the buyer gets — almost certainly "a collectible and supporter perks, **not** rights to the character" — and say so in plain language, or you will either undercut the brand or mislead the buyer.
